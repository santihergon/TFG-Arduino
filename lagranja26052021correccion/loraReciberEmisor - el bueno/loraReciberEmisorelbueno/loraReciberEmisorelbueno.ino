...
String id = "0"; //Seria tipo int y de valor null ?
String accion = "100";//Seria tipo int ?
String cantidad = "0"; //Seria tipo int y de valor null ?
...
void loop() {
  ...
  if (packetSize) {
    ...
    while (LoRa.available()) {
      ...
      // datoSensor3 = datosLoraRecibidos.substring(pos1 + 1, datosLoraRecibidos.length());
      tipoMedidaSensor3 = datosLoraRecibidos.substring(pos2 + 1, datosLoraRecibidos.length());
    }
...
// Preparo el actuador
  actuador = String(id) + "/" + String(accion) + "&" + String(cantidad);
